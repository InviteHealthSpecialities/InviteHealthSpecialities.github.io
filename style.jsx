...
import { createStyles } from "@mantine/core"; //For import mantine required functions and theme
...
const useStyles = createStyles((theme) => ({
    ...
    SettingBox2: {
        ...
        borderRadius: "8px",
        border: `1px solid ${theme.colorScheme === "dark" ? theme.colors.zevcore[9] : " white"
            }`,
        boxShadow: `0 0px 2px 2px ${theme.colorScheme === "dark"
                ? "rgba(75, 79, 83, 0.007)"
    ...
    BankBox: {
        ...
        color: theme.colorScheme === "dark" ? "white" : "black",
        borderRadius: "8px",
        border: `1px solid ${theme.colorScheme === "dark" ? theme.colors.zevcore[9] : "#EEEEEE"
            }`,
        boxShadow: `0 0px 2px 2px ${theme.colorScheme === "dark"
                ? "rgba(75, 79, 83, 0.007)"
                : "rgba(175, 183, 190, 0.007)"
    ...
    // For banking transaction box active status
    BankBoxActive: {
        height: 130,
        width: 160,
        padding: 20,
