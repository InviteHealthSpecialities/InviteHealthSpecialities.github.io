...
import {
    ...
    X,
    Check,
} from "tabler-icons-react"; // For particular icons that has used in this page from tabler icon //Imports icons
import {
    Badge,
    Button,
    Card,
    ...
    NumberInput,
    ScrollArea,
} from "@mantine/core"; //For import mantine required functions and theme //for import mantine required functions and theme //mantine main core imports lists
